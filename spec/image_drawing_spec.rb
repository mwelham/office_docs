  ...
  describe ImageDrawing do
    ...
    describe 'with mocks' do
      it 'normal drawing' do
        imdr = ImageDrawing.new wsdr_node: wsdr, img: image, loc: loc, rel_id: rel_id
      ...
      describe 'optional extent' do
        ...
        it 'overrides with hash' do
          imdr = ImageDrawing.new wsdr_node: wsdr, img: image, loc: loc, rel_id: 'sum_dum_rel_id', extent: {width: 132, height: 625}
        ...
        it 'overrides with object' do
          imdr = ImageDrawing.new wsdr_node: wsdr, img: image, loc: loc, rel_id: 'sum_dum_rel_id', extent: OpenStruct.new(width: 1066, height: 403)
      ...
      describe 'drawing.xml' do
        ...
        let :imdr do ImageDrawing.new wsdr_node: wsdr, img: image, loc: loc, rel_id: rel_id, extent: {width: 28, height: 21} end
    ...
    describe 'with reals' do
      ...
      it 'normal drawing' do
        imdr = ImageDrawing.new wsdr_node: wsdr, img: image, loc: loc, rel_id: rel_id, extent: {width: 57, height: 91}
    ...
    it 'creates correct *:cNvPr/@id values'
  end
end
